...
You need to have the latest version of [VS Code](https://code.visualstudio.com)
and VS Code
...
You need to have [WebStorm](https://www.jetbrains.com/webstorm/) and
...
[page to see it in action](https://prettier.io/playground/).
