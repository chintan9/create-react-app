...
module.exports = function(proxy, allowedHost) {
  return {
    ...
    // path as
    // we specified in the Webpack config. When homepage is '.', default to
    // serving
    // from the root.
    ...
    before(app, server) {
      ...
      // middlewares before `redirectServedPath` otherwise will not have any
      // effect This lets us fetch source contents from webpack for the error
      // overlay
